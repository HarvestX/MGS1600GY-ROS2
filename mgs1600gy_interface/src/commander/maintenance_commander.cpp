...
RESPONSE_STATE MaintenanceCommander::calibrateMagnet() const noexcept
{
...
RESPONSE_STATE MaintenanceCommander::calibrateGyro() const noexcept
{
...
RESPONSE_STATE MaintenanceCommander::saveConfig() const noexcept
{
